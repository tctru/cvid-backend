app.controller('newscatsController', ['$scope', '$http', '$rootScope', '$routeParams','$location','ngDialog','$route','FileUploader',
    function ($scope, $http, $rootScope,$routeParams, $location,ngDialog,$route,FileUploader) {
        ...
        $scope.openaddproducttypes = function (size) {
          $location.path("/administrator/newnewscats");
        };
        ...
        $scope.savenewscats = function () {
                ...
                $http({
                    ...
                    if(result["result"]==0){
                        ...
                        $location.path("/administrator/newscats");
                    }       
                })
...
app.controller('editnewscatsController', ['$scope', '$http', '$rootScope', '$routeParams','$location','ngDialog','$route','FileUploader',
    function ($scope, $http, $rootScope,$routeParams, $location,ngDialog,$route,FileUploader) {
        // this configuration depends on your site.
        //debugger;
        //
        ...
        $scope.divadd = true;
        $http.get('/newscats/getnewscatinfo?id='+$routeParams['id']).success(function(data) {
            //$route.reload();
        ...
        $scope.saveeditnewscat = function () {
                var Employee = {
